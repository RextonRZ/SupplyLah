                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {[
                    ...
                    },
                    {
                      ...
                      sub: "low-confidence orders",
                      valueColor:
                        stats.requires_review > 0
                          ? "text-red-600"
                          : "text-slate-300",
                    },
                    ...
                    <div
                      key={label}
                      className={`bg-white rounded-xl border p-5 ${label === "Needs Review" && stats.requires_review > 0 ? "border-red-200" : "border-slate-200"}`}
                    >
            ...
            <div className="max-w-7xl mx-auto flex flex-row gap-6 items-start h-[calc(100vh-180px)]">
              ...
              <div className="w-52 shrink-0 flex flex-col gap-3 mr-2">
                ...
                <p className="text-[10px] text-slate-400 leading-relaxed px-1">
                  Different phone numbers create different customers in the
                  dashboard.
                </p>
              ...
              <div className="relative h-[740px] aspect-[9/18.5] shrink-0 select-none drop-shadow-2xl">
                <img
                  ...
                  alt="phone"
                />
                <div className="absolute top-[2.2%] left-[6%] right-[6.6%] bottom-[2.2%] z-10 overflow-hidden rounded-[2.6rem] bg-[#e5ddd5]">
                  <MockChat
                    key={demoChatKey}
